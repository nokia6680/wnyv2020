...
if (formSend) {
    formSend.addEventListener('click', function() {
        ...
        setTimeout(function() {
            return formSuccess.classList.remove('hidden');
        }, 1000);
        setTimeout(function() {
            return formSuccess.classList.add('visible');
        }, 1500);
        setTimeout(function() {
            return formSuccess.classList.remove('visible');
        }, 10000);
        setTimeout(function() {
            return formSuccess.classList.add('hidden');
        }, 11000);
        setTimeout(function() {
...
if (startLink) {
    startLink.addEventListener('click', function() {
        ...
        setTimeout(function() {
            return stepIntro.classList.add('hidden');
        }, 1000);
        setTimeout(function() {
            return stepMap.classList.add('visible');
        }, 1000);
        setTimeout(function() {
            ...
            header.classList.add('step-1');
        }, 1500); //footer.classList.remove('invisible');
    });
}
...
if (linkChoose) {
    linkChoose.addEventListener('click', function() {
        ...
        setTimeout(function() {
            return stepMap.classList.add('hidden');
        }, 1000);
        setTimeout(function() {
            return stepChoose.classList.add('visible');
        }, 1000);
        setTimeout(function() {
...
if (linkPlayer) {
    linkPlayer.addEventListener('click', function() {
        ...
        setTimeout(function() {
            return stepPlayer.classList.add('visible');
        }, 1000);
        setTimeout(function() {
...
if (linkFinal) {
    linkFinal.addEventListener('click', function() {
        ...
        setTimeout(function() {
            return stepFinal.classList.add('visible');
        }, 1000);
        setTimeout(function() {
...
if (linkTv) {
    linkTv.addEventListener('click', function() {
        ...
        setTimeout(function() {
            return stepTv.classList.add('visible');
        }, 1000);
        setTimeout(function() {
...
if (linkPrize) {
    linkPrize.addEventListener('click', function() {
        ...
        setTimeout(function() {
            return stepPrize.classList.add('visible');
        }, 1000);
        setTimeout(function() {
...
if (linkWinner) {
    linkWinner.addEventListener('click', function() {
        ...
        setTimeout(function() {
            return stepWinner.classList.add('visible');
        }, 1000);
        setTimeout(function() {
